...
_BANDS = {
    ...
    "sea": [  # 云海:灰绿(与小程序云海标签同族,2026-07-11)
        (10, 25, (235, 240, 238)), (25, 40, (214, 228, 222)),
        (40, 55, (180, 207, 196)), (55, 70, (140, 180, 166)),
        (70, 85, (103, 150, 134)), (85, 101, (74, 122, 106))],
    "rainbow": [  # 彩虹:雾蓝(与小程序彩虹标签同族)
        (10, 25, (233, 239, 243)), (25, 40, (210, 224, 232)),
        (40, 55, (174, 199, 214)), (55, 70, (134, 168, 190)),
        (70, 85, (99, 138, 164)), (85, 101, (71, 110, 136))],
}
...
def _draw_legend(draw, kind, x0, y0, width, font):
    ...
    for i, (lo, hi, color) in enumerate(bands):
        ...
        x += seg
    label = {"prob": "概率 %", "quality": "鲜艳度(质量)%",
             "sea": "云海概率 %", "rainbow": "彩虹条件 %"}[kind]
    draw.text((x + 8, y0 + 2), label, fill=_CITY_TXT, font=font)
    tiers = {"prob": "参考: <20渺茫 20-40不大 40-60留意 60-80较大 ≥80大概率",
             "quality": "档位: <20不烧 20-40微烧 40-60小烧 60-80中烧 80-90大烧 ≥90爆烧",
             "sea": "三道门连乘: 成雾 × 雾顶档位 × 有光",
             "rainbow": "条件: 反日雨幕 × 光路开 × 太阳几何"}[kind]
